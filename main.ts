sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    ...
    info.startCountdown(3.050213)
    Basket_ball.setPosition(randint(0, 160), randint(0, 120))
})
let Basket_ball: Sprite = null
scene.setBackgroundImage(img`
    ...
    ddddd111dddddddddddddddddddddddddddddddddddddd111dddddddddddddddddddd111ddddddddddddddddd111dddddddddddddddddddd111ddddddddddddddddddddddddddddddddddddd111ddddd
    `)
let The_best_basketballer = sprites.create(img`
    ...................
    ......fffffff......
    .....ffeeeeeff.....
    .....feffeffef.....
    ...
    ..fffffff.fffffff..
    `, SpriteKind.Player)
controller.moveSprite(The_best_basketballer)
Basket_ball = sprites.create(img`
    . . . . . f f f f f f f . . . . . 
